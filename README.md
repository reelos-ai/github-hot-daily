...
- `/` - 情报中心首页
- `/daily/` - 日报入口
- `/daily/2026-08-31/` - 当前日报
- `/weekly/` - 周报入口
- `/weekly/2026-08-30/` - 当前周报
- `/monthly/` - 月报入口
- `/monthly/2026-08/` - 当前月报
...
- HTML: `/monthly/2026-08/`
- Top 10 data: `/monthly-top10-2026-08.json`
- Raw trending data: `/monthly-trending-data-2026-08.json`

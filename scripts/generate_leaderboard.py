  ...
  <div class="shell">
    ...
    <main id="main">
      ...
      <details class="method">
        ...
        <p>总分 100：持续入榜 30%、增长信号 20%、战略评分 20%、近期热度 15%、最佳名次 10%、最近出现 5%。增长信号取“快照期间 Star 变化”和“单期最高增长”的较高值。它是当前样本内的相对分，每次更新会重新标定；Star 只代表关注度，不等于采用度、生产可用性或商业价值。中文摘要优先来自 project-briefs-zh.json 的人工摘要，缺失时保留仓库原始 description 并标明来源，不做猜测式翻译。</p>
      </details>
    </main>

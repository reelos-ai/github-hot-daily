...
def shell_css() -> str:
    ...
    *{box-sizing:border-box}
    ...
    .nav a.active,.nav a:hover{
      color:var(--text);border-color:var(--line-strong);background:rgba(190,203,255,.38);
    }
    .hero{
    ...
    h1{margin:16px 0 10px;font-size:clamp(42px,8vw,86px);line-height:.98;letter-spacing:-.045em;font-weight:650;font-family:Sora,"Space Grotesk","IBM Plex Sans",ui-sans-serif,system-ui,sans-serif}
    ...
    .row:hover{background:rgba(190,203,255,.18);transform:translateX(2px);border-color:rgba(182,193,235,.9)}

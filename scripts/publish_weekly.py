...
def upsert_report_entry(period: str, stats: dict, assets: dict) -> list[dict]:
    ...
    payload = {
        "updated_at": shared_publisher.report_timestamp(period),
        "site": SITE,
        "reports": reports,
    }
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--period", help="Weekly report period in YYYY-MM-DD. Defaults to latest weekly entry in reports.json.")
